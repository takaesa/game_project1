...
#define ID_SPRITE_LAND_BEGIN (ID_SPRITE_LAND+1000)
#define ID_SPRITE_LAND_MIDDLE (ID_SPRITE_LAND+2000)
#define ID_SPRITE_LAND_END (ID_SPRITE_LAND+3000)
